...
page_title: "exo_retention_policy_tag Data Source - exo"
subcategory: ""
description: |-
  Look up an existing RetentionPolicyTag object. Set identity or name to select it.
---

# exo_retention_policy_tag (Data Source)
