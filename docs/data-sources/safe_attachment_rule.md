...
page_title: "exo_safe_attachment_rule Data Source - exo"
subcategory: ""
description: |-
  Look up an existing SafeAttachmentRule object. Set identity or name to select it.
---

# exo_safe_attachment_rule (Data Source)
