...
page_title: "exo_mailboxes Data Source - exo"
subcategory: ""
description: |-
  List every Mailbox object (Get-Mailbox).
---

# exo_mailboxes (Data Source)
...
- `mailboxes` (Attributes List) All Mailbox objects. (see [below for nested schema](#nestedatt--mailboxes))
