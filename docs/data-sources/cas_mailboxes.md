...
page_title: "exo_cas_mailboxes Data Source - exo"
subcategory: ""
description: |-
  List every CASMailbox object (Get-CASMailbox).
---

# exo_cas_mailboxes (Data Source)
...
- `cas_mailboxes` (Attributes List) All CASMailbox objects. (see [below for nested schema](#nestedatt--cas_mailboxes))

<a id="nestedatt--cas_mailboxes"></a>
### Nested Schema for `cas_mailboxes`
