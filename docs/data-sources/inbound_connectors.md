...
page_title: "exo_inbound_connectors Data Source - exo"
subcategory: ""
description: |-
  List every InboundConnector object (Get-InboundConnector).
---

# exo_inbound_connectors (Data Source)
...
- `inbound_connectors` (Attributes List) All InboundConnector objects. (see [below for nested schema](#nestedatt--inbound_connectors))

<a id="nestedatt--inbound_connectors"></a>
### Nested Schema for `inbound_connectors`
