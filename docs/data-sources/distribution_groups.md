...
page_title: "exo_distribution_groups Data Source - exo"
subcategory: ""
description: |-
  List every DistributionGroup object (Get-DistributionGroup).
---

# exo_distribution_groups (Data Source)
...
- `distribution_groups` (Attributes List) All DistributionGroup objects. (see [below for nested schema](#nestedatt--distribution_groups))

<a id="nestedatt--distribution_groups"></a>
