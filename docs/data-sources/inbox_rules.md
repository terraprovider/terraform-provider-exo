...
page_title: "exo_inbox_rules Data Source - exo"
subcategory: ""
description: |-
  List every InboxRule object (Get-InboxRule).
---

# exo_inbox_rules (Data Source)
...
- `inbox_rules` (Attributes List) All InboxRule objects. (see [below for nested schema](#nestedatt--inbox_rules))

<a id="nestedatt--inbox_rules"></a>
### Nested Schema for `inbox_rules`
