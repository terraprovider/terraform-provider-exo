...
page_title: "exo_quarantine_policies Data Source - exo"
subcategory: ""
description: |-
  List every QuarantinePolicy object (Get-QuarantinePolicy).
---

# exo_quarantine_policies (Data Source)
...
- `quarantine_policies` (Attributes List) All QuarantinePolicy objects. (see [below for nested schema](#nestedatt--quarantine_policies))

<a id="nestedatt--quarantine_policies"></a>
### Nested Schema for `quarantine_policies`
