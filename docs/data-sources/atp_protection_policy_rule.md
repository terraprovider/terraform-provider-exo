...
page_title: "exo_atp_protection_policy_rule Data Source - exo"
subcategory: ""
description: |-
  Look up an existing ATPProtectionPolicyRule object. Set identity or name to select it.
---

# exo_atp_protection_policy_rule (Data Source)
