...
page_title: "exo_unified_groups Data Source - exo"
subcategory: ""
description: |-
  List every UnifiedGroup object (Get-UnifiedGroup).
---

# exo_unified_groups (Data Source)
...
- `unified_groups` (Attributes List) All UnifiedGroup objects. (see [below for nested schema](#nestedatt--unified_groups))

<a id="nestedatt--unified_groups"></a>
### Nested Schema for `unified_groups`
