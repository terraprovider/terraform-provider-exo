...
page_title: "exo_dynamic_distribution_groups Data Source - exo"
subcategory: ""
description: |-
  List every DynamicDistributionGroup object (Get-DynamicDistributionGroup).
---

# exo_dynamic_distribution_groups (Data Source)
...
- `dynamic_distribution_groups` (Attributes List) All DynamicDistributionGroup objects. (see [below for nested schema](#nestedatt--dynamic_distribution_groups))

<a id="nestedatt--dynamic_distribution_groups"></a>
### Nested Schema for `dynamic_distribution_groups`
