...
page_title: "exo_mail_public_folders Data Source - exo"
subcategory: ""
description: |-
  List every MailPublicFolder object (Get-MailPublicFolder).
---

# exo_mail_public_folders (Data Source)
...
- `mail_public_folders` (Attributes List) All MailPublicFolder objects. (see [below for nested schema](#nestedatt--mail_public_folders))

<a id="nestedatt--mail_public_folders"></a>
### Nested Schema for `mail_public_folders`
