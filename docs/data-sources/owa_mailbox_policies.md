...
page_title: "exo_owa_mailbox_policies Data Source - exo"
subcategory: ""
description: |-
  List every OwaMailboxPolicy object (Get-OwaMailboxPolicy).
---

# exo_owa_mailbox_policies (Data Source)
...
- `owa_mailbox_policies` (Attributes List) All OwaMailboxPolicy objects. (see [below for nested schema](#nestedatt--owa_mailbox_policies))

<a id="nestedatt--owa_mailbox_policies"></a>
### Nested Schema for `owa_mailbox_policies`
