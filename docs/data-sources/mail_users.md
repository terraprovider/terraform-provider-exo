...
page_title: "exo_mail_users Data Source - exo"
subcategory: ""
description: |-
  List every MailUser object (Get-MailUser).
---

# exo_mail_users (Data Source)
...
- `mail_users` (Attributes List) All MailUser objects. (see [below for nested schema](#nestedatt--mail_users))

<a id="nestedatt--mail_users"></a>
### Nested Schema for `mail_users`
