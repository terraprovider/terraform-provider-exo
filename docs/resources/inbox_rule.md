...
page_title: "exo_inbox_rule Resource - exo"
subcategory: ""
description: |-
  Manages the InboxRule object via New-InboxRule / Get-InboxRule / Set-InboxRule / Remove-InboxRule.
---

# exo_inbox_rule (Resource)
